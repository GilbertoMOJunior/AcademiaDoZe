...
namespace AcademiaDoZe.Domain.Tests
{
    public class LogradouroDomainTests
    {
        ...
        {
            Assert.Throws<DomainException>(() => Logradouro.Criar(1, "Casa", "1234567", "Brasil", "SP", "SP", "Centro"));      
        }

        [Fact]
        public void CriarLogradouro_Valido_VerificarNormalizado()
        {
            var logradouro = Logradouro.Criar(1, "Casa  ", "1234./567-8", "  Brasil  ", "S P", " SP ", "  Centro");
        ...
        {
            var exception = Assert.Throws<DomainException>(() => Logradouro.Criar(1, "", "12345678", "Brasil", "SP", "SP", "Centro"));
