...
using AcademiaDoZe.Infraestrutura.Repositorios;
...
namespace AcademiaDoZe.Infra.Tests.Testes
{
    public class LogradouroInfrastructureTests : TestBase
    {
        ...
        public async Task Logradouro_Adicionar()
        {
            ...
            var logradouro = Logradouro.Criar(1, "Rua dos Testes", _cep, "Pais teste", "TS", "Cidade Teste", "Bairro Teste");
        ...
        public async Task Logradouro_ObterPorCep_Atualizar()
        {
            ...
            // Atualizar
            var logradouroAtualizado = Logradouro.Criar(1, "Rua Atualizada", _cep, "Pais atualizado", "AT", "Cidade Atualizada", "Bairro Atualizado");
